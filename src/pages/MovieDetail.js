      ...
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <div className="flex items-center">
              ...
              <p className="ms-2 text-gray-900 font-bold text-lg dark:text-white">{movie.vote_average}</p>
...
{/* base link for imdb is not given in the api only code is given ... so we took it from the imdb website...which is imdb.com/title/code/ */}
        </div>
      </section>
    </main>
  );
